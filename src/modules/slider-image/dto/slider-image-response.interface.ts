...
} from './slider-image-response.dto';
...
export class SuccessSliderImagesWithTagsResponseDto {
  @ApiProperty({
    description: 'HTTP status code',
    example: 200,
  })
  ...
  @ApiProperty({
    description: 'Response data containing slider images with associated tags',
    type: [SliderImageWithTagsResponseDto],
  })
  data: SliderImageWithTagsResponseDto[];
