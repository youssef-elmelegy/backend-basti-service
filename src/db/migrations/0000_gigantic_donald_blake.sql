...
CREATE TYPE "public"."notification_type_enum" AS ENUM('order_update', 'order_status', 'order_cancelled_by_bakery', 'promotion', 'system', 'review', 'new_order', 'offer', 'coupon');--> statement-breakpoint
...
CREATE TABLE "orders" (
	...
	"driver" jsonb,
	"delivery_check_code_hash" varchar(255),
	"delivery_check_code_expires_at" timestamp,
	"location_id" uuid,
	...
	"mini_cakes_total" integer DEFAULT 0 NOT NULL,
	"coupon" jsonb,
	"basti_delivery_amount" integer DEFAULT 0 NOT NULL,
	"basti_percentage" numeric(10, 2) DEFAULT '0.20' NOT NULL,
	"mini_cake_percentage" numeric(10, 2) DEFAULT '0.10' NOT NULL,
...
CREATE TABLE "app_config" (
	...
	"basti_percentage" numeric(10, 2) DEFAULT '0.20' NOT NULL,
	"mini_cake_percentage" numeric(10, 2) DEFAULT '0.10' NOT NULL,
	"printing_fee" jsonb DEFAULT '{"normal": 10, "suger": 20}'::jsonb NOT NULL,
	"delivery_amount" integer DEFAULT 10 NOT NULL,
	"basti_delivery_amount" integer DEFAULT 0 NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "admins" ADD CONSTRAINT "admins_region_id_regions_id_fk" FOREIGN KEY ("region_id") REFERENCES "public"."regions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "orders" ADD CONSTRAINT "orders_driver_id_admins_id_fk" FOREIGN KEY ("driver_id") REFERENCES "public"."admins"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "reports" ADD CONSTRAINT "reports_driver_id_admins_id_fk" FOREIGN KEY ("driver_id") REFERENCES "public"."admins"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "region_item_prices" ADD CONSTRAINT "region_item_prices_offer_id_offers_id_fk" FOREIGN KEY ("offer_id") REFERENCES "public"."offers"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "admins_region_id_idx" ON "admins" USING btree ("region_id");--> statement-breakpoint
...
CREATE INDEX "reports_driver_id_idx" ON "reports" USING btree ("driver_id");--> statement-breakpoint
