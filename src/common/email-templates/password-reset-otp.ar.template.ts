export const passwordResetOtpArTemplate = (otp: string, userName: string) => {
  return `
    <!DOCTYPE html>
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          تلقّينا طلبًا لإعادة تعيين كلمة المرور الخاصة بك. استخدم رمز التحقق
          الموضح أدناه للمتابعة.
        </p>
